...
export class ResourcesPage extends React.Component {
    ...
    // displayed resources are hard-coded and defined here, but they could just as easily be passed in as a JSON or .csv
        ...
        if (this.props.match.params.resourceType == "food") {
            resources = [
                ...
                },
                {
                    ...
                    resourceType:"PDF",
                    tags: ["food", "english", "seattle", "spanish"],
                    links: [
            ...
            resources = [
                ...
                },
                {
                    ...
                    resourceType: "PDF",
                    tags: ["seattle", "english", "spanish", "arabic"],
                    links: [
    ...
    render() {
        ...
        let titleDisplay = this.props.match.params.resourceType.slice(0,1).toUpperCase() + this.props.match.params.resourceType.slice(1,this.props.match.params.resourceType.length);
        return (
            <body>
...
export class SideNav extends React.Component {
    render() {
        ...
        let languages = ["english", "spanish", "russian", "vietnamese", "somali", "arabic"].map((language) => {
            return <CheckBox tag={language} callback={this.props.callback}/>
        })
        let locations = ["seattle", "tacoma", "kirkland", "bellevue"].map((location) => {
